...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_val_max = new QLabel(groupBox_midi);
        label_val_max->setObjectName(QStringLiteral("label_val_max"));

        gridLayout->addWidget(label_val_max, 0, 3, 1, 1);

        label_channel = new QLabel(groupBox_midi);
        label_channel->setObjectName(QStringLiteral("label_channel"));

        gridLayout->addWidget(label_channel, 0, 4, 1, 1);
        ...
        gridLayout->addWidget(spinBox_val_max, 1, 3, 1, 1);
        ...
        gridLayout_5->addWidget(label_type_3, 0, 0, 1, 1);

        label_num_3 = new QLabel(groupBox_midi_3);
        label_num_3->setObjectName(QStringLiteral("label_num_3"));

        gridLayout_5->addWidget(label_num_3, 0, 1, 1, 1);

        label_val_3 = new QLabel(groupBox_midi_3);
        label_val_3->setObjectName(QStringLiteral("label_val_3"));

        gridLayout_5->addWidget(label_val_3, 0, 2, 1, 1);

        label_val_max_3 = new QLabel(groupBox_midi_3);
        label_val_max_3->setObjectName(QStringLiteral("label_val_max_3"));

        gridLayout_5->addWidget(label_val_max_3, 0, 3, 1, 1);

        label_channel_3 = new QLabel(groupBox_midi_3);
        label_channel_3->setObjectName(QStringLiteral("label_channel_3"));

        gridLayout_5->addWidget(label_channel_3, 0, 4, 1, 1);
        ...
        gridLayout_5->addWidget(comboBox_type_3, 1, 0, 1, 1);
        ...
        gridLayout_5->addWidget(spinBox_num_3, 1, 1, 1, 1);
        ...
        gridLayout_5->addWidget(spinBox_val_3, 1, 2, 1, 1);

        spinBox_val_max_3 = new QSpinBox(groupBox_midi_3);
        spinBox_val_max_3->setObjectName(QStringLiteral("spinBox_val_max_3"));
        spinBox_val_max_3->setMinimumSize(QSize(100, 0));
        spinBox_val_max_3->setAlignment(Qt::AlignCenter);
        spinBox_val_max_3->setMinimum(0);
        spinBox_val_max_3->setMaximum(127);

        gridLayout_5->addWidget(spinBox_val_max_3, 1, 3, 1, 1);
        ...
        gridLayout_5->addWidget(spinBox_channel_3, 1, 4, 1, 1);


        gridLayout_7->addWidget(groupBox_midi_3, 3, 0, 1, 4);

        groupBox_midi_5 = new QGroupBox(centralWidget);
        groupBox_midi_5->setObjectName(QStringLiteral("groupBox_midi_5"));
        gridLayout_6 = new QGridLayout(groupBox_midi_5);
        ...
        gridLayout_6->addWidget(label_type_5, 0, 0, 1, 1);

        label_num_5 = new QLabel(groupBox_midi_5);
        label_num_5->setObjectName(QStringLiteral("label_num_5"));

        gridLayout_6->addWidget(label_num_5, 0, 1, 1, 1);

        label_val_5 = new QLabel(groupBox_midi_5);
        label_val_5->setObjectName(QStringLiteral("label_val_5"));

        gridLayout_6->addWidget(label_val_5, 0, 2, 1, 1);

        label_val_max_5 = new QLabel(groupBox_midi_5);
        label_val_max_5->setObjectName(QStringLiteral("label_val_max_5"));

        gridLayout_6->addWidget(label_val_max_5, 0, 3, 1, 1);

        label_channel_5 = new QLabel(groupBox_midi_5);
        label_channel_5->setObjectName(QStringLiteral("label_channel_5"));

        gridLayout_6->addWidget(label_channel_5, 0, 4, 1, 1);
        ...
        gridLayout_6->addWidget(comboBox_type_5, 1, 0, 1, 1);
        ...
        gridLayout_6->addWidget(spinBox_num_5, 1, 1, 1, 1);
        ...
        gridLayout_6->addWidget(spinBox_val_5, 1, 2, 1, 1);

        spinBox_val_max_5 = new QSpinBox(groupBox_midi_5);
        spinBox_val_max_5->setObjectName(QStringLiteral("spinBox_val_max_5"));
        spinBox_val_max_5->setMinimumSize(QSize(100, 0));
        spinBox_val_max_5->setAlignment(Qt::AlignCenter);
        spinBox_val_max_5->setMinimum(0);
        spinBox_val_max_5->setMaximum(127);

        gridLayout_6->addWidget(spinBox_val_max_5, 1, 3, 1, 1);
        ...
        gridLayout_6->addWidget(spinBox_channel_5, 1, 4, 1, 1);


        gridLayout_7->addWidget(groupBox_midi_5, 5, 0, 1, 4);
        ...
        gridLayout_7->addWidget(pushButton_save, 6, 1, 1, 1);
        ...
        lineEdit_shortName->setMinimumSize(QSize(140, 0));
        ...
        gridLayout_4->addWidget(label_type_4, 0, 0, 1, 1);

        label_num_4 = new QLabel(groupBox_midi_4);
        label_num_4->setObjectName(QStringLiteral("label_num_4"));

        gridLayout_4->addWidget(label_num_4, 0, 1, 1, 1);

        label_val_4 = new QLabel(groupBox_midi_4);
        label_val_4->setObjectName(QStringLiteral("label_val_4"));

        gridLayout_4->addWidget(label_val_4, 0, 2, 1, 1);

        label_val_max_4 = new QLabel(groupBox_midi_4);
        label_val_max_4->setObjectName(QStringLiteral("label_val_max_4"));

        gridLayout_4->addWidget(label_val_max_4, 0, 3, 1, 1);

        label_channel_4 = new QLabel(groupBox_midi_4);
        label_channel_4->setObjectName(QStringLiteral("label_channel_4"));

        gridLayout_4->addWidget(label_channel_4, 0, 4, 1, 1);
        ...
        gridLayout_4->addWidget(comboBox_type_4, 1, 0, 1, 1);
        ...
        gridLayout_4->addWidget(spinBox_num_4, 1, 1, 1, 1);
        ...
        gridLayout_4->addWidget(spinBox_val_4, 1, 2, 1, 1);

        spinBox_val_max_4 = new QSpinBox(groupBox_midi_4);
        spinBox_val_max_4->setObjectName(QStringLiteral("spinBox_val_max_4"));
        spinBox_val_max_4->setMinimumSize(QSize(100, 0));
        spinBox_val_max_4->setAlignment(Qt::AlignCenter);
        spinBox_val_max_4->setMinimum(0);
        spinBox_val_max_4->setMaximum(127);

        gridLayout_4->addWidget(spinBox_val_max_4, 1, 3, 1, 1);
        ...
        gridLayout_4->addWidget(spinBox_channel_4, 1, 4, 1, 1);


        gridLayout_7->addWidget(groupBox_midi_4, 4, 0, 1, 4);

        groupBox_midi_2 = new QGroupBox(centralWidget);
        groupBox_midi_2->setObjectName(QStringLiteral("groupBox_midi_2"));
        gridLayout_3 = new QGridLayout(groupBox_midi_2);
        ...
        gridLayout_3->addWidget(label_type_2, 0, 0, 1, 1);

        label_num_2 = new QLabel(groupBox_midi_2);
        label_num_2->setObjectName(QStringLiteral("label_num_2"));

        gridLayout_3->addWidget(label_num_2, 0, 1, 1, 1);

        label_val_2 = new QLabel(groupBox_midi_2);
        label_val_2->setObjectName(QStringLiteral("label_val_2"));

        gridLayout_3->addWidget(label_val_2, 0, 2, 1, 1);

        label_val_max_2 = new QLabel(groupBox_midi_2);
        label_val_max_2->setObjectName(QStringLiteral("label_val_max_2"));

        gridLayout_3->addWidget(label_val_max_2, 0, 3, 1, 1);

        label_channel_2 = new QLabel(groupBox_midi_2);
        label_channel_2->setObjectName(QStringLiteral("label_channel_2"));

        gridLayout_3->addWidget(label_channel_2, 0, 4, 1, 1);
        ...
        gridLayout_3->addWidget(comboBox_type_2, 1, 0, 1, 1);
        ...
        gridLayout_3->addWidget(spinBox_num_2, 1, 1, 1, 1);
        ...
        gridLayout_3->addWidget(spinBox_val_2, 1, 2, 1, 1);

        spinBox_val_max_2 = new QSpinBox(groupBox_midi_2);
        spinBox_val_max_2->setObjectName(QStringLiteral("spinBox_val_max_2"));
        spinBox_val_max_2->setMinimumSize(QSize(100, 0));
        spinBox_val_max_2->setAlignment(Qt::AlignCenter);
        spinBox_val_max_2->setMinimum(0);
        spinBox_val_max_2->setMaximum(127);

        gridLayout_3->addWidget(spinBox_val_max_2, 1, 3, 1, 1);
        ...
        gridLayout_3->addWidget(spinBox_channel_2, 1, 4, 1, 1);


        gridLayout_7->addWidget(groupBox_midi_2, 2, 0, 1, 4);

        pushButton_reset = new QPushButton(centralWidget);
        pushButton_reset->setObjectName(QStringLiteral("pushButton_reset"));
        pushButton_reset->setMinimumSize(QSize(100, 40));

        gridLayout_7->addWidget(pushButton_reset, 6, 2, 1, 1);
        ...
        label_val_max->setBuddy(spinBox_val_max);
        ...
        label_val_max_3->setBuddy(spinBox_val_max_3);
        ...
        label_val_max_5->setBuddy(spinBox_val_max_5);
        ...
        label_val_max_4->setBuddy(spinBox_val_max_4);
        ...
        label_val_max_2->setBuddy(spinBox_val_max_2);
        ...
        QWidget::setTabOrder(spinBox_val, spinBox_val_max);
        QWidget::setTabOrder(spinBox_val_max, spinBox_channel);
        ...
        QWidget::setTabOrder(spinBox_val_2, spinBox_val_max_2);
        QWidget::setTabOrder(spinBox_val_max_2, spinBox_channel_2);
        ...
        QWidget::setTabOrder(spinBox_val_3, spinBox_val_max_3);
        QWidget::setTabOrder(spinBox_val_max_3, spinBox_channel_3);
        ...
        QWidget::setTabOrder(spinBox_val_4, spinBox_val_max_4);
        QWidget::setTabOrder(spinBox_val_max_4, spinBox_channel_4);
        ...
        QWidget::setTabOrder(spinBox_val_5, spinBox_val_max_5);
        QWidget::setTabOrder(spinBox_val_max_5, spinBox_channel_5);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_num->setText(QApplication::translate("MainWindow", "Number 1", 0));
        label_val->setText(QApplication::translate("MainWindow", "Value 1", 0));
        label_val_max->setText(QApplication::translate("MainWindow", "Value 2", 0));
        ...
        label_num_3->setText(QApplication::translate("MainWindow", "Number 1", 0));
        label_val_3->setText(QApplication::translate("MainWindow", "Value 1", 0));
        label_val_max_3->setText(QApplication::translate("MainWindow", "Value 2", 0));
        ...
        label_num_5->setText(QApplication::translate("MainWindow", "Number 1", 0));
        label_val_5->setText(QApplication::translate("MainWindow", "Value 1", 0));
        label_val_max_5->setText(QApplication::translate("MainWindow", "Value 2", 0));
        ...
        label_num_4->setText(QApplication::translate("MainWindow", "Number 1", 0));
        label_val_4->setText(QApplication::translate("MainWindow", "Value 1", 0));
        label_val_max_4->setText(QApplication::translate("MainWindow", "Value 2", 0));
        ...
        label_num_2->setText(QApplication::translate("MainWindow", "Number 1", 0));
        label_val_2->setText(QApplication::translate("MainWindow", "Value 1", 0));
        label_val_max_2->setText(QApplication::translate("MainWindow", "Value 2", 0));
